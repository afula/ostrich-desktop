...
class NativeImpl extends FlutterRustBridgeBase<NativeWire> implements Native {
  ...
  Future<int> leafRun(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_leaf_run(
            port_,
            _api2wire_String(configPath),
            _api2wire_String(wintunPath),
            _api2wire_String(tun2SocksPath)),
  ...
  Future<bool> isRunning({dynamic hint}) => executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_is_running(port_),
  ...
  Future<bool> leafShutdown({dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_leaf_shutdown(port_),
        parseSuccessData: _wire2api_bool,
        constMeta: const FlutterRustBridgeTaskConstMeta(
